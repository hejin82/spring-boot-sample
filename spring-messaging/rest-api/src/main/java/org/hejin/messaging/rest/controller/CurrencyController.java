package org.hejin.messaging.rest.controller;

import java.text.SimpleDateFormat;
import java.util.Date;

import org.hejin.messaging.rest.domain.CurrencyConversion;
import org.hejin.messaging.rest.domain.CurrencyExchange;
import org.hejin.messaging.rest.domain.Rate;
import org.hejin.messaging.rest.service.CurrencyConversionService;
...
public class CurrencyController {
    ...
    public ResponseEntity<CurrencyExchange> getLatest(
        ...
        return new ResponseEntity<CurrencyExchange>(
                new CurrencyExchange(base, new SimpleDateFormat("yyyy-MM-dd").format(new Date()),
    ...
    public ResponseEntity<CurrencyExchange> getByDate(
            ...
            throws Exception {
        return new ResponseEntity<CurrencyExchange>(
                new CurrencyExchange(base, new SimpleDateFormat("yyyy-MM-dd").format(date),
    ...
    public ResponseEntity<CurrencyConversion> conversion(@PathVariable("amount") Float amount,
            @PathVariable("base") String base, @PathVariable("code") String code) throws Exception {
    ...
    public ResponseEntity<CurrencyExchange> addNewRates(
            @RequestBody CurrencyExchange currencyExchange) throws Exception {
        try {
